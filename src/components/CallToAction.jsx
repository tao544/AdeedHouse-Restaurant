...
const CallToAction = () => {
  return (
    <div className="bg-light py-5 px-4 text-center rounded shadow-lg  mx-auto">
      <h3 className="text-2xl font-semibold text-warning mb-3">Ready to Enjoy a Great Meal?</h3>
      ...
      <div className="d-flex justify-content-center gap-3">
        <a
          href="https://order.adeedhouse.com"
          className="btn btn-warning  font-bold px-4 py-2 hover:text-black"
        >
          Order Now
        </a>
         <Link
