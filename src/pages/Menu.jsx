...
const categoryStyles = {
  localDishes: "bg-light bg-opacity-75 p-4 rounded",
  continentalDishes: "bg-dark bg-opacity-50 text-white p-4 rounded",
  drinksDesserts: "bg-light bg-opacity-75 p-4 rounded",
};
  ...
  return (
    <div className="container py-5">
      ...
      {Object.entries(menuData).map(([category, items]) => (
        <div
          key={category}
          className={`mb-5 ${categoryStyles[category]}`}
        >
          <h3 className="text-amber-800! mb-4 text-center">
